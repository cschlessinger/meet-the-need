...
Customer.create(first_name: "Masha", last_name: "Lifshin", email: "masha@example.com", zipcode: "90210", password: "password")
Customer.create(first_name: "Julian", last_name: "Bouma", email: "julian@example.com", zipcode: "90210", password: "password")

Developer.create(first_name: "Sasha", last_name: "Goldenson", email: "sasha@example.com", zipcode: "81239", password: "password")
Developer.create(first_name: "Claire", last_name: "Schlessinger", email: "claire@example.com", zipcode: "81239", password: "password")
Developer.create(first_name: "Katie", last_name: "Ok", email: "katie@example.com", zipcode: "81239", password: "password", tagline: "I am the bestest developer ever", bio: "That's all.")
Developer.create(first_name: "Andrew", last_name: "Dowd", email: "andrew@example.com", zipcode: "81239", password: "password", tagline: "I am the bestest developer ever", bio: "That's all.")
...
Project.create(title: "Animal Protection App", body: "This is to protect animals", customer_id: 1, cost: 350)
Project.create(title: "Finance Tracking App", body: "This is better manage my finance", customer_id: 1, cost: 350)
Project.create(title: "Bowling league App", body: "Virtual bowling app", customer_id: 1, cost: 950)
Project.create(title: "Healthcare websites App", body: "This will disrupt the healthcare industry", customer_id: 1, cost: 525, assigned_date: '2015-11-01', developer_id: 3, is_completed: false)
