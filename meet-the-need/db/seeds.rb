...
Customer.create(first_name: "Zedechiah", last_name: "Smith", email: "zedsmith@example.com", zipcode: "90210")
Customer.create(first_name: "Monroe", last_name: "Smith", email: "monroesmith@example.com", zipcode: "90210")
Customer.create(first_name: "Tyler", last_name: "Smith", email: "tysmith@example.com", zipcode: "90210")
